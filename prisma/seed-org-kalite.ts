// prisma/seed-org-kalite.ts
// F1 — Organizasyon Şeması: Kalite Müdürlüğü PİLOT verisi (EK-A A.12)
//
// ÇALIŞTIRMA (HENÜZ ÇALIŞTIRILMADI — Elif onayı bekliyor):
//   npx tsx prisma/seed-org-kalite.ts
//
// İdempotent: her çalıştırmada YALNIZ "ORG-KL" ve "ORG-KL-*" kod uzayı
// temizlenip yeniden kurulur. ORG-IV/ORG-FB/ORG-SA/ORG-FN/ORG-MH dahil başka
// hiçbir bölüme dokunulmaz.
//
// Personnel ve Position tablolarına SADECE OKUMA (findMany) yapılır;
// create/update/delete kesinlikle yok.
//
// DÜZELTME: İlk sürümdeki ağaç yanlıştı (Kaynak Kalite Sorumlusu/vekalet kutusu
// yoktu; Kerem Akbay altındakiler iç içe kurulmuştu; Giriş Kalite Operatörleri
// yanlış bağlıydı). Bu sürümde bu departmanda VEKALET YOK, ağaç düzeltildi.
//
// Not (P07/P08, P09/P10, P13/P14): Aynı unvan farklı kutu (Fabrika P27 / Finans
// P06'daki mantıkla aynı) — name aynı yazıldı ki rol eşleşmesi (normalize→Position)
// her ikisinde de tutarlı çalışsın.
//
// Not (P08, P16): İsim yok → BOŞ KADRO, employees=[], vekaletDurumu=false, M=0 sarı.
//
// Not (Ceren Çelik): P02 (Kaynak Koordinatörü) ve P15 (Kaynak Mühendisi) —
// aynı kişi iki ayrı kutuda. Kaynak veri böyle, hata değil, aynen yansıtıldı.
...
// ─── NORMALIZE (İK/Fabrika/Satınalma/Finans/Mühendislik seed'indeki AYNI fonksiyon) ──
...
const NODES: SeedNode[] = [
  ...
  {
    code: "ORG-KL-P02",
    parentCode: "ORG-KL-P01",
    unitType: "POSITION",
    name: "Kaynak Koordinatörü",
    level: 2,
    sortOrder: 0,
    approvedHeadcount: 1,
    employees: ["Ceren Çelik"],
  },
  {
    code: "ORG-KL-P03",
    parentCode: "ORG-KL-P01",
    unitType: "POSITION",
    name: "Kalite Müdür Yardımcısı",
    level: 2,
    sortOrder: 1,
    approvedHeadcount: 1,
    employees: ["Batuhan Çapar"],
  },
  {
    code: "ORG-KL-P04",
    parentCode: "ORG-KL-P03",
    unitType: "POSITION",
    name: "Kalite Sorumlusu",
    level: 3,
    sortOrder: 0,
    approvedHeadcount: 1,
    employees: ["Kerem Akbay"],
  },
  {
    code: "ORG-KL-P05",
    parentCode: "ORG-KL-P04",
    unitType: "POSITION",
    name: "Proses Kalite & CMM Hat Sorumlusu",
    level: 4,
    sortOrder: 0,
    approvedHeadcount: 1,
    employees: ["Onur Çetin"],
  },
  {
    code: "ORG-KL-P06",
    parentCode: "ORG-KL-P04",
    ...
    sortOrder: 1,
    approvedHeadcount: 1,
    employees: ["Muhammet Demir"],
  },
  {
    code: "ORG-KL-P07",
    parentCode: "ORG-KL-P04",
    unitType: "POSITION",
    name: "Proses Kalite Operatörü",
    level: 4,
    sortOrder: 2,
    approvedHeadcount: 1,
    employees: ["D. Barış Esen"],
  },
  {
    code: "ORG-KL-P08",
    parentCode: "ORG-KL-P04",
    unitType: "POSITION",
    // Not: P07 ile aynı gerçek unvan (bkz. dosya başı notu)
    name: "Proses Kalite Operatörü",
    level: 4,
    sortOrder: 3,
    approvedHeadcount: 1,
  ...
  },
  {
    ...
    parentCode: "ORG-KL-P04",
    unitType: "POSITION",
    // Not: P09 ile aynı gerçek unvan (bkz. dosya başı notu)
    name: "Final Kalite Operatörü",
    level: 4,
    sortOrder: 5,
    approvedHeadcount: 1,
    employees: ["Kadriye Öztürk"],
  },
  {
    code: "ORG-KL-P11",
    parentCode: "ORG-KL-P04",
    unitType: "POSITION",
    name: "Kalite Duvarı Operatörü",
    level: 4,
    sortOrder: 6,
    approvedHeadcount: 1,
    employees: ["Meryem Yıldırım"],
  },
  {
    code: "ORG-KL-P12",
    parentCode: "ORG-KL-P03",
    unitType: "POSITION",
    name: "Tedarikçi Kalite Geliştirme Sorumlusu",
    level: 3,
    sortOrder: 1,
    approvedHeadcount: 1,
    employees: ["Nisan Deniz Çongara"],
  },
  {
    code: "ORG-KL-P13",
    parentCode: "ORG-KL-P12",
    unitType: "POSITION",
    name: "Giriş Kalite Operatörü",
    level: 4,
    sortOrder: 0,
    approvedHeadcount: 1,
  ...
  },
  {
    ...
    parentCode: "ORG-KL-P12",
    unitType: "POSITION",
    // Not: P13 ile aynı gerçek unvan (bkz. dosya başı notu)
    name: "Giriş Kalite Operatörü",
    level: 4,
    sortOrder: 1,
    approvedHeadcount: 1,
  ...
  },
  {
    ...
    parentCode: "ORG-KL-P03",
    unitType: "POSITION",
    name: "Kaynak Mühendisi",
    level: 3,
    sortOrder: 2,
    approvedHeadcount: 1,
    employees: ["Ceren Çelik"], // P02 ile aynı kişi — kasıtlı, aynen
  },
  {
    code: "ORG-KL-P16",
    parentCode: "ORG-KL-P15",
    unitType: "POSITION",
    name: "Kaynak Lab. Kalite Operatörü",
    level: 4,
    sortOrder: 0,
    approvedHeadcount: 1,
    employees: [], // BOŞ KADRO
  },
  {
    ...
    parentCode: "ORG-KL-P03",
    unitType: "POSITION",
    name: "Sistem Kalite Sorumlusu",
    level: 3,
    sortOrder: 3,
    approvedHeadcount: 1,
    employees: ["A. Ozan Çiçek"],
  },
];

// ─── SORUMLU TABLOSU (yalnız ORG-KL düğümü, EK-A A.12) ───────────────────

const SORUMLULUKLAR: { sira: number; birinciSorumlu: string; yedekSorumlu: string }[] = [
  { sira: 1, birinciSorumlu: "Sami Tekoğlu", yedekSorumlu: "Batuhan Çapar" },
  { sira: 2, birinciSorumlu: "Batuhan Çapar", yedekSorumlu: "Kerem Akbay" },
];
...
async function main() {
  console.log("F1 — Kalite Müdürlüğü pilotu yükleniyor...\n");

  // ── 1) İDEMPOTENT TEMİZLİK — yalnız ORG-KL / ORG-KL-* kapsamı ──────────
  // Tam eşleşme "ORG-KL" ya da "ORG-KL-" öneki: "ORG-KLX" gibi bir kod
  // yanlışlıkla yakalanmaz (startsWith("ORG-KL") tek başına yakalardı).
  const mevcut = await prisma.orgUnit.findMany({
    where: { OR: [{ code: "ORG-KL" }, { code: { startsWith: "ORG-KL-" } }] },
    select: { id: true },
  });
  ...
  if (mevcutIds.length > 0) {
    ...
    console.log(`Temizlendi: ${mevcutIds.length} eski ORG-KL* OrgUnit kaydı.\n`);
  }
  ...
  // ── 5) OrgBolumMeta + OrgSorumluluk (yalnız ORG-KL) ─────────────────────
  const orgKlId = idByCode.get("ORG-KL")!;
  ...
  // ── 6) RAPOR ─────────────────────────────────────────────────────────────
  console.log("=== F1 SEED RAPORU — Kalite Müdürlüğü Pilotu ===\n");
  ...
  for (const r of boxRaporu) {
    console.log(
      `${r.kod.padEnd(12)} | ${r.unvan.padEnd(36)} | ${String(r.n).padEnd(1)} | ${String(r.m).padEnd(1)} | ${r.rozet.padEnd(12)} | ${r.vekalet}`
    );
  }

...
// IFS EĞİTİM DEĞERLENDİRME — departman → KİŞİ listesi (YÖNETİCİ ekranı).
//
// Sunucu kapısı page.tsx'te (hasPermission("ifs.admin")); bu dosya yalnız
// istemci tarafı. Ayrım 2026-09'da yapıldı — sayfa baştan sona "use client"
// olduğu için guard'sızdı ve yetkisiz biri URL'i bilirse boş kabuk görüyordu.
//
...
export function EgitimDegerlendirme() {
                      ...
                      >
                        ...
                        <td className="px-3 py-2 text-right align-top">
                          <button
                            ...
                            onClick={(ev) => {
                              ev.stopPropagation();
                              router.push(`/ifs/degerlendirme/${d.packageId}`);
                            }}

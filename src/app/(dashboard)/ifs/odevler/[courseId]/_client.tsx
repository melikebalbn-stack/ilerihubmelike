...
// IFS ÖDEVLER — alan detayı (drill-down Sv3).
//
...
// (/akademi/ifs → /ifs/odevler). Artık üç seviye de /ifs altında.
//
...
export function IfsOdevAlanDetay() {
  ...
  const backHref = dept
    ? `/ifs/odevler?dept=${encodeURIComponent(dept)}`
    : "/ifs/odevler";

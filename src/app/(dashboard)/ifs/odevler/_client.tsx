...
export function IfsOdevlerKatalog() {
  ...
  const openDept = useCallback(
    (d: Department) => {
      ...
      router.replace(`/ifs/odevler?dept=${encodeURIComponent(d.packageId)}`);
    },
    [loadAreas, router]
  );
      ...
      >
        ...
        <div className="relative p-6 sm:p-7 flex items-center gap-5">
          ...
          <div className="min-w-0">
            <h1 className="text-2xl font-bold text-white">IFS Ödevleri</h1>

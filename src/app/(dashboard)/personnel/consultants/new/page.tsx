...
export default function NewConsultantPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Danisman basariyla olusturuldu")
      router.push("/personnel?tab=danisman")
    } catch (err: any) {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold">Yeni Danisman</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end gap-3">
          <Button type="button" variant="outline" asChild>
            <Link href="/personnel?tab=danisman">Iptal</Link>
          </Button>

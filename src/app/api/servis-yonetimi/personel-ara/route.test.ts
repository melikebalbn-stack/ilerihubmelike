...
describe('Servis personel arama route', () => {
  it('servis.tanim.manage, servis.sorumlu.manage veya servis.create ister ve reddedilirse prisma çağrılmaz', async () => {
    ...
    expect(mocks.requirePermission).toHaveBeenCalledWith(['servis.tanim.manage', 'servis.sorumlu.manage', 'servis.create'])
